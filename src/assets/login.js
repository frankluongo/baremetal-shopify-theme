...
function toggleRecoverPasswordForm() {
  document.querySelector(selectors.recoverPasswordForm).classList.toggle('dnone');
  document.querySelector(selectors.loginForm).classList.toggle('dnone');
}
...
function resetPasswordSuccess() {
  ...
  if (document.querySelector(selectors.formState)) {
    document.querySelector(selectors.resetSuccess).classList.remove('dnone');
  }
}
